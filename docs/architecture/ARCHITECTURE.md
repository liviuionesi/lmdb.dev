...
| [021](adr/021-vosk-bilingual-model-selection.md)         | Bilingual English/German Vosk speech-to-text models selected for offline voice control                                                                                                                                                                                                                                         |
| [022](adr/022-config-server-access-control.md)           | Config Server access control and secret protection mechanisms                                                                                                                                                                                                                                                                  |
| [023](adr/023-multi-step-natural-language-search.md)     | Multi-step natural-language search pipeline with entity grounding, Wikidata resolution, and fallbacks                                                                                                                                                                                                                          |
| [024](adr/024-explicit-docker-compose-volume-naming.md)  | All Docker Compose volumes across all microservices set explicit `name: lmdb_*` prefixes to prevent cross-project volume collisions on shared developer hosts                                                                                                                                                                 |
