 ...
 *
 * <p>Structurally identical to {@link Favorite} but kept as a separate entity/table: the two lists
 * have independent lifecycles and future behavior (e.g. watchlist ordering, watched-state) would
 * diverge.
 */
@Entity
@Table(
