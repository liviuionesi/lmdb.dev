...
/**
 * MapStruct mapper encapsulating all conversions between TMDB API records,
 * domain {@link Actor} entities, and native API DTOs.
 *
 * <p>Generates type-safe mapping code at build time, replacing manual
 * field-by-field copying while preserving zero-reflection execution speed.</p>
 */
...
public interface ActorMapper {
    ...
    /**
     * Converts a domain {@link Actor} entity into a TMDB person detail response shape
     * for facade serialization.
     *
     * @param actor entity
