 ...
 * TmdbPersonResponse ↔ ActorSummaryDto) and ensure null safety for sparse inputs.</p>
 */
...
class ActorMapperTest {
    ...
    /**
     * Verifies that mapping from a TMDB API {@link TmdbPersonResponse} record to a domain {@link Actor}
     * entity maps all matching attributes and initializes sync timestamp.
     */
    @Test
    ...
    void toEntityMapsResponseToEntity() {
        TmdbPersonResponse response = new TmdbPersonResponse(
            200L, "Jane Doe", "Biography", LocalDate.of(1990, Month.JANUARY, 1),
            "Paris", "/jane.jpg", 99.0, List.of("Janey"), "Directing",
            1, "nm7654321", "https://jane.com", false
        );
    ...
    /**
     * Verifies that a null biography in a {@link TmdbPersonResponse} is normalized to an empty string on the entity.
     */
    @Test
    @DisplayName("toEntity: handles null biography")
    void toEntityNormalizesNullBiography() {
        TmdbPersonResponse response = new TmdbPersonResponse(
            200L, "Jane Doe", null, null, null, null,
    ...
    /**
     * Verifies that passing a null {@link TmdbPersonResponse} to {@link ActorMapper#toEntity} returns null.
     */
    @Test
    ...
    /**
     * Verifies that mapping from a domain {@link Actor} entity to a TMDB facade {@link TmdbPersonResponse}
     * accurately maps all fields to TMDB's response envelope shape.
     */
    @Test
    ...
    /**
     * Verifies that passing a null {@link Actor} entity to {@link ActorMapper#toTmdbPersonResponse} returns null.
     */
    @Test
    ...
    /**
     * Verifies that mapping from a {@link TmdbPersonSummary} list hit to a native {@link ActorSummaryDto}
     * carries all summary fields.
     */
    @Test
    @DisplayName("toSummaryDto: maps TmdbPersonSummary to ActorSummaryDto")
    void toSummaryDtoMapsSummaryToDto() {
        TmdbPersonSummary summary = new TmdbPersonSummary(
            400L, "Summary Actor", "/sum.jpg", 45.0, "Acting", 2, false
        );
    ...
    /**
     * Verifies that passing a null {@link TmdbPersonSummary} to {@link ActorMapper#toSummaryDto} returns null.
     */
    @Test
