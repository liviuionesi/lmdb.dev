 ...
 * and the TMDB-shaped facade ({@link com.filmpire.movie.facade.TmdbFacadeController}) that exposes
 * TMDB's exact v3 paths/field names for the Filmpire React app. Both read and write the SAME
...
public class MovieService {
   ...
   * com.filmpire.movie.facade.TmdbFacadeController} (which goes through the proxy, so the cache
