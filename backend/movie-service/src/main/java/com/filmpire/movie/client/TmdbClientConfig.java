 ...
 * facade ({@code com.filmpire.movie.facade}) as of ADR-010; there is no longer a separate
 * raw/untyped client.
 *
...
public class TmdbClientConfig {
  ...
  /**
   * The single shared HTTP client for all TMDB traffic: base URL, JSON headers, and the rate-limit
   * interceptor.
   *
