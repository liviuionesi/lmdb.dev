...
/**
 * The franchise/collection a movie belongs to (e.g. "The Dark Knight Collection"), as TMDB's {@code
 * belongs_to_collection} field reports it. Null for standalone movies.
 *
