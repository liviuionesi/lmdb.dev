 ...
 *
 * <p>Exposes the exact TMDB v3 paths the Filmpire React app calls (extracted from its {@code
 ...
 * are being retargeted at Filmpire's own user-service JWT flow rather than proxied to real TMDB
