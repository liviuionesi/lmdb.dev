...
/** Http Client for TMDB API. Base URL and API key are configured in application.yml. */
@HttpExchange
public interface TmdbClient {
  ...
  TmdbMovieResponse getMovieDetails(
      @PathVariable("movieId") Long movieId, @RequestParam("api_key") String apiKey);
  ...
  TmdbGenresResponse getGenres(@RequestParam("api_key") String apiKey);
}
