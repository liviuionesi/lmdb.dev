 ...
 * com.filmpire.ai.controller.AiController}) and gRPC ({@link com.filmpire.ai.grpc.AiGrpcService}).
 * Eureka client registration is auto-configured when the eureka-client dependency is present.
 */
