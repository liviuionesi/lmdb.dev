...
/**
 * Converts a Java {@code float[]} embedding to pgvector's text input format
 * ({@code "[0.1,0.2,...]"}) for binding into the native ANN query in
 * {@link UserTasteProfileRepository#findNearestNeighbours}.
 */
