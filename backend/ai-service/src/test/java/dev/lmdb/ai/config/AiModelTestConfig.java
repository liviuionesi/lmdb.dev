 ...
 * Ollama, no Vosk model). {@link dev.lmdb.ai.client.MovieCatalogClient}'s load-balanced {@link
 ...
 * dev.lmdb.ai.integration.AiServiceIntegrationTest}).
 */
@TestConfiguration
public class AiModelTestConfig {
   ...
   *     contract, not Vosk itself (that's {@link dev.lmdb.ai.service.SpeechToTextServiceTest}'s
   *     job)
   */
  @Bean
  @Primary
