package dev.lmdb.gateway.contract;
...
@AutoConfigureStubRunner(
    ids = "dev.lmdb:actor-service:+:stubs:9974",
...
class ActorServiceContractTest {
  ...
  /**
   * Registers dynamic properties for Redis container host/port and points actor-service gateway
   * route to StubRunner.
   *
