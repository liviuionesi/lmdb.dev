...
class ResourceNotFoundExceptionTest {
  ...
  /**
   * The plain-message constructor is for callers who already built their own message;
   * resourceType/resourceId are not derivable from it and must stay null rather than guess.
   */
  @Test
