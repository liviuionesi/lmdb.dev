...
class BusinessExceptionTest {
    ...
    /**
     * The single-arg constructor must default the error code rather than
     * leave it null, since callers use it for client-side error handling.
     */
    @Test
    ...
    /**
     * The two-arg constructor must use the caller-supplied error code
    ...
    /**
     * The three-arg constructor must preserve both the error code and the
     * chained cause.
     */
    @Test
