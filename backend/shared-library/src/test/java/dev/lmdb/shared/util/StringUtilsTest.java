 ...
 *
 * <p>This test class verifies the functionality of the StringUtils utility class, including:
 *
 * <ul>
 *   <li>String validation (empty, blank, not empty, not blank)
 *   <li>Default value handling
 *   <li>String transformation (trim, capitalize, case conversion)
 *   <li>String truncation
 *   <li>Format validation (email, URL)
 *   <li>String masking for security
 *   <li>String joining operations
 *   <li>Character type checking (numeric, alphabetic, alphanumeric)
 * </ul>
 *
...
class StringUtilsTest {
  ...
  /**
   * Tests that {@link StringUtils#isEmpty(String)} returns true for null or empty strings, and
   * false for non-empty strings. Verifies correct identification of empty strings.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isBlank(String)} returns true for null, empty, or whitespace-only
   * strings, and false for strings with content. Verifies correct identification of blank strings.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isNotEmpty(String)} returns true for non-empty strings and false
   * for null or empty strings. Verifies the inverse of isEmpty functionality.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isNotBlank(String)} returns true for non-blank strings and false
   * for null, empty, or whitespace-only strings. Verifies the inverse of isBlank functionality.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#defaultIfEmpty(String, String)} returns the default value when
   * the input is null or empty, otherwise returns the input string. Verifies default value
  ...
  /**
   * Tests that {@link StringUtils#defaultIfBlank(String, String)} returns the default value when
   * the input is null, empty, or blank, otherwise returns the input string. Verifies default value
   * substitution for blank strings.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#trimToNull(String)} trims whitespace and returns null if the
   * result is empty or blank, otherwise returns the trimmed string. Verifies trimming and null
   * conversion behavior.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#capitalize(String)} capitalizes the first letter of a string
   * while keeping the rest lowercase. Verifies correct capitalization of strings including edge
   * cases.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#toCamelCase(String)} converts strings with various separators
   * (underscore, hyphen, space) to camelCase format. Verifies correct camelCase conversion.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#toSnakeCase(String)} converts camelCase or kebab-case strings to
   * snake_case format. Verifies correct snake_case conversion.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#truncate(String, int)} truncates a string to the specified
   * maximum length. Verifies correct truncation behavior including null handling.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#truncateWithEllipsis(String, int)} truncates a string and appends
   * ellipsis when the string exceeds the maximum length. Verifies ellipsis addition for truncated
   * strings.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isValidEmail(String)} validates email addresses using a standard
   * email pattern. Verifies correct email validation including various valid and invalid formats.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isValidUrl(String)} validates URLs using a standard URL pattern
   * supporting http, https, and ftp protocols. Verifies correct URL validation including various
  ...
  /**
   * Tests that {@link StringUtils#mask(String, int, char)} masks middle characters of a string
   * while preserving the specified number of characters at the start and end. Verifies correct
   * string masking for security purposes.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#maskEmail(String)} masks email addresses by hiding parts of the
   * local and domain sections. Verifies correct email masking for privacy protection.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#join(String, String...)} joins an array of strings using the
   * specified delimiter. Verifies correct string joining with various delimiters.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#join(String, List)} joins a list of strings using the specified
   * delimiter. Verifies correct string joining from collections.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#removeWhitespace(String)} removes all whitespace characters from
   * a string. Verifies correct whitespace removal.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isNumeric(String)} returns true only for strings containing
   * digits exclusively. Verifies correct numeric string validation.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isAlphabetic(String)} returns true only for strings containing
   * letters exclusively. Verifies correct alphabetic string validation.
   */
  @Test
  ...
  /**
   * Tests that {@link StringUtils#isAlphanumeric(String)} returns true only for strings containing
   * letters and digits exclusively (no special characters). Verifies correct alphanumeric string
   * validation.
   */
  @Test
