...
/**
 * Detailed error response for exception handling. Provides comprehensive error information
 * including validation errors and debugging details.
 *
...
public class ErrorResponse {
  ...
  public static ErrorResponse withValidationErrors(
      int status, String errorCode, String message, String path, Map<String, String> fieldErrors) {
    return ErrorResponse.builder()
        .status(status)
        .errorCode(errorCode)
        .message(message)
