...
## Definition of Ready
- [ ] Meets [Definition of Ready](https://github.com/pehlivanu/filmpire-microservices/blob/develop/docs/process/DEFINITION_OF_READY.md)
...
## Definition of Done
- [ ] Meets [Definition of Done](https://github.com/pehlivanu/filmpire-microservices/blob/develop/docs/process/DEFINITION_OF_DONE.md)
