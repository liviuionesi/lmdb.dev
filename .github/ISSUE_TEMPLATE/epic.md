...
<!-- The outcome this epic delivers. Name what exists at the end, not the
     slot in the schedule it occupies. "Project Setup Phase" was the wrong
     shape; "Buildable project foundation" is the right one. -->
...
<!-- Child Stories are the native sub-issue links and nothing else. Add
     ...
     here on purpose: it duplicated the panel, needed re-syncing by hand on
     every edit, and a stale checkbox once hid the open Task #120 under the
     closed Story #77.
